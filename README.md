...
> **Archived:** This project is no longer maintained. It's kept public for reference, but issues and pull requests are closed.
...
This project is archived and no longer maintained. Issues and pull requests are closed, but feel free to fork it if it's useful to you.

---

Copyright (c) 2015-2020, Cecil Wöbker.
